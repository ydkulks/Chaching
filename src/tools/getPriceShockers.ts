...
export const metadata: ToolMetadata = {
  name: "getPriceShockers",
  description: "Fetch price shockers",
  annotations: {
    title: "Get Price Shockers",
    readOnlyHint: true,
...
// Tool implementation
export default async function getPriceShockers() {
  const apiKey = process.env.INDIAN_API_KEY;
  const url = `https://stock.indianapi.in/price_shockers`;
