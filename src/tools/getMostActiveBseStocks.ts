...
export const metadata: ToolMetadata = {
  ...
  description: "Fetch the most active stocks from the BSE",
  annotations: {
...
// Tool implementation
export default async function getMostActiveStocks() {
  const apiKey = process.env.INDIAN_API_KEY;
  const url = `https://stock.indianapi.in/BSE_most_active`;
